...
<body>
  ...
  <tbody>
    ...
    <div id="formula">
    <form action="./formulariopublicacionreg.php" method="POST" id="formulario">
        <div class="formulario">
            <p id="pn">actualiza publicacion</p>
             <p id="pn3">seleccione el id de la publicacion a actualizar</p>
